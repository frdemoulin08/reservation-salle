...
final class Version20260203121500 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE log_reset_password (id INT AUTO_INCREMENT NOT NULL, user_id INT DEFAULT NULL, identifier VARCHAR(255) NOT NULL, event_type VARCHAR(32) NOT NULL, occurred_at DATETIME NOT NULL, ip_address VARCHAR(45) DEFAULT NULL, user_agent LONGTEXT DEFAULT NULL, failure_reason VARCHAR(255) DEFAULT NULL, INDEX IDX_5FC40DB3A76ED395 (user_id), INDEX idx_log_reset_password_occurred_at (occurred_at), created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4');
        $this->addSql('CREATE TABLE cron_task_run (id INT AUTO_INCREMENT NOT NULL, command VARCHAR(255) NOT NULL, status VARCHAR(20) NOT NULL, started_at DATETIME NOT NULL, finished_at DATETIME DEFAULT NULL, duration_ms INT DEFAULT NULL, exit_code INT DEFAULT NULL, summary VARCHAR(255) DEFAULT NULL, output LONGTEXT DEFAULT NULL, error LONGTEXT DEFAULT NULL, context JSON DEFAULT NULL, INDEX idx_cron_task_run_started_at (started_at), INDEX idx_cron_task_run_status (status), created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4');
        $this->addSql('CREATE TABLE messenger_messages (id BIGINT AUTO_INCREMENT NOT NULL, body LONGTEXT NOT NULL, headers LONGTEXT NOT NULL, queue_name VARCHAR(190) NOT NULL, created_at DATETIME NOT NULL, available_at DATETIME NOT NULL, delivered_at DATETIME DEFAULT NULL, INDEX IDX_75EA56E0FB7336F0E3BD61CE16BA31DBBF396750 (queue_name, available_at, delivered_at, id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        $this->addSql('CREATE TABLE additional_fee_type (id INT AUTO_INCREMENT NOT NULL, code VARCHAR(50) NOT NULL, label VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_5F19E70777153098 (code), created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        $this->addSql('CREATE TABLE equipment_type (id INT AUTO_INCREMENT NOT NULL, code VARCHAR(50) NOT NULL, label VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_B65A862F77153098 (code), created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        $this->addSql('CREATE TABLE equipment (id INT AUTO_INCREMENT NOT NULL, equipment_type_id INT NOT NULL, label VARCHAR(255) NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, INDEX IDX_D9A7D2BEB337437C (equipment_type_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        $this->addSql('CREATE TABLE event_type (id INT AUTO_INCREMENT NOT NULL, code VARCHAR(50) NOT NULL, label VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_93151B8277153098 (code), created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        $this->addSql('CREATE TABLE organization (id INT AUTO_INCREMENT NOT NULL, siret VARCHAR(20) DEFAULT NULL, legal_name VARCHAR(255) NOT NULL, display_name VARCHAR(255) NOT NULL, legal_nature VARCHAR(255) DEFAULT NULL, organization_type VARCHAR(50) DEFAULT NULL, association_registered TINYINT DEFAULT 0 NOT NULL, billing_same_as_head_office TINYINT DEFAULT 0 NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, head_office_line1 VARCHAR(255) NOT NULL, head_office_line2 VARCHAR(255) DEFAULT NULL, head_office_line3 VARCHAR(255) DEFAULT NULL, head_office_postal_code VARCHAR(10) NOT NULL, head_office_city VARCHAR(100) DEFAULT NULL, head_office_country VARCHAR(2) NOT NULL, head_office_source VARCHAR(50) DEFAULT NULL, head_office_external_id VARCHAR(255) DEFAULT NULL, head_office_latitude DOUBLE PRECISION DEFAULT NULL, head_office_longitude DOUBLE PRECISION DEFAULT NULL, billing_line1 VARCHAR(255) NOT NULL, billing_line2 VARCHAR(255) DEFAULT NULL, billing_line3 VARCHAR(255) DEFAULT NULL, billing_postal_code VARCHAR(10) NOT NULL, billing_city VARCHAR(100) DEFAULT NULL, billing_country VARCHAR(2) NOT NULL, billing_source VARCHAR(50) DEFAULT NULL, billing_external_id VARCHAR(255) DEFAULT NULL, billing_latitude DOUBLE PRECISION DEFAULT NULL, billing_longitude DOUBLE PRECISION DEFAULT NULL, UNIQUE INDEX UNIQ_C1EE637C26E94372 (siret), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        $this->addSql('CREATE TABLE country (id INT AUTO_INCREMENT NOT NULL, public_identifier VARCHAR(36) NOT NULL, code VARCHAR(2) NOT NULL, label VARCHAR(100) NOT NULL, dialing_code VARCHAR(8) DEFAULT NULL, is_active TINYINT DEFAULT 1 NOT NULL, UNIQUE INDEX UNIQ_5373C96677153098 (code), UNIQUE INDEX UNIQ_5373C9661FC56738 (public_identifier), created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        $this->addSql('CREATE TABLE organization_contact (id INT AUTO_INCREMENT NOT NULL, role VARCHAR(50) NOT NULL, title VARCHAR(20) DEFAULT NULL, job_title VARCHAR(255) DEFAULT NULL, first_name VARCHAR(255) NOT NULL, last_name VARCHAR(255) NOT NULL, email VARCHAR(255) NOT NULL, phone VARCHAR(20) DEFAULT NULL, organization_id INT NOT NULL, INDEX IDX_81B06E7B32C8A3DE (organization_id), created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        ...
        $this->addSql('CREATE TABLE reservation_additional_fee (id INT AUTO_INCREMENT NOT NULL, amount NUMERIC(10, 2) NOT NULL, label VARCHAR(255) DEFAULT NULL, reservation_id INT NOT NULL, additional_fee_type_id INT NOT NULL, INDEX IDX_A3F66AF1B83297E7 (reservation_id), INDEX IDX_A3F66AF1165A1E01 (additional_fee_type_id), created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        $this->addSql('CREATE TABLE room (id INT AUTO_INCREMENT NOT NULL, public_identifier VARCHAR(36) NOT NULL, name VARCHAR(255) NOT NULL, description LONGTEXT DEFAULT NULL, surface_area NUMERIC(10, 2) DEFAULT NULL, seated_capacity INT DEFAULT NULL, standing_capacity INT DEFAULT NULL, is_pmr_accessible TINYINT DEFAULT 0 NOT NULL, has_elevator TINYINT DEFAULT 0 NOT NULL, has_pmr_restrooms TINYINT DEFAULT 0 NOT NULL, has_emergency_exits TINYINT DEFAULT 0 NOT NULL, is_erp_compliant TINYINT DEFAULT 0 NOT NULL, erp_type VARCHAR(50) DEFAULT NULL, erp_category VARCHAR(50) DEFAULT NULL, security_staff_required TINYINT DEFAULT 0 NOT NULL, opening_hours_schema LONGTEXT DEFAULT NULL, min_rental_duration_minutes INT DEFAULT NULL, max_rental_duration_minutes INT DEFAULT NULL, booking_lead_time_days INT DEFAULT NULL, catering_allowed TINYINT DEFAULT 0 NOT NULL, alcohol_allowed TINYINT DEFAULT 0 NOT NULL, alcohol_legal_notice LONGTEXT DEFAULT NULL, music_allowed TINYINT DEFAULT 0 NOT NULL, sacem_required TINYINT DEFAULT 0 NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, venue_id INT NOT NULL, UNIQUE INDEX UNIQ_729F519B1FC56738 (public_identifier), INDEX IDX_729F519B40A73EBA (venue_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        ...
        $this->addSql('CREATE TABLE room_document (id INT AUTO_INCREMENT NOT NULL, label VARCHAR(255) NOT NULL, file_path VARCHAR(255) NOT NULL, mime_type VARCHAR(100) DEFAULT NULL, type VARCHAR(50) DEFAULT NULL, room_id INT NOT NULL, INDEX IDX_788F4AB254177093 (room_id), created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        $this->addSql('CREATE TABLE room_equipment (id INT AUTO_INCREMENT NOT NULL, max_quantity INT DEFAULT NULL, exclusive_to_room TINYINT DEFAULT 0 NOT NULL, is_included TINYINT DEFAULT 1 NOT NULL, room_id INT NOT NULL, equipment_type_id INT NOT NULL, INDEX IDX_4F9135EA54177093 (room_id), INDEX IDX_4F9135EAB337437C (equipment_type_id), created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        $this->addSql('CREATE TABLE room_layout (id INT AUTO_INCREMENT NOT NULL, code VARCHAR(50) NOT NULL, label VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_7B74AD2377153098 (code), created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        ...
        $this->addSql('ALTER TABLE equipment ADD CONSTRAINT FK_D9A7D2BEB337437C FOREIGN KEY (equipment_type_id) REFERENCES equipment_type (id)');
